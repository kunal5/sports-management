...
public class DeleteClerk extends JFrame implements ActionListener
{
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteClerk frame = new DeleteClerk();
	...
	public void populateCombo()
	{
		...
		String strsql="select name from clerks";
	...
	int option=	JOptionPane.showConfirmDialog(this, "are u sure");
			...
			String strdelete="delete from clerks where name=?";
				try{
